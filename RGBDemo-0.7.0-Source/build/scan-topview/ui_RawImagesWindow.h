...
public:
    ...
    void setupUi(QMainWindow *RawImagesWindow)
    {
        ...
        RawImagesWindow->resize(766, 582);
        ...
        menuShow->addAction(action_Show_Modeler);
    ...
    void retranslateUi(QMainWindow *RawImagesWindow)
    {
        ...
        label_2->setText(QApplication::translate("RawImagesWindow", "Integration time", 0, QApplication::UnicodeUTF8));
