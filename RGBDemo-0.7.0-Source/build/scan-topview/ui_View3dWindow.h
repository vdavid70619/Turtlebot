...
public:
    ...
    void setupUi(QMainWindow *View3DWindow)
    {
        ...
        findObjectsCheckBox = new QCheckBox(frame);
        findObjectsCheckBox->setObjectName(QString::fromUtf8("findObjectsCheckBox"));

        horizontalLayout->addWidget(findObjectsCheckBox);
    ...
    void retranslateUi(QMainWindow *View3DWindow)
    {
        ...
        showPlaneCheckBox->setText(QApplication::translate("View3DWindow", "Show plane", 0, QApplication::UnicodeUTF8));
        findObjectsCheckBox->setText(QApplication::translate("View3DWindow", "Find objects", 0, QApplication::UnicodeUTF8));
