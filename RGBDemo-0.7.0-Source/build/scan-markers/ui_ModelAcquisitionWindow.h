...
**
** Created: Mon Apr 30 12:49:09 2012
...
public:
    ...
    QPushButton *removeFloorPlaneButton;
    ...
    void setupUi(QMainWindow *ModelAcquisitionWindow)
    {
        ...
        removeFloorPlaneButton = new QPushButton(frame_4);
        removeFloorPlaneButton->setObjectName(QString::fromUtf8("removeFloorPlaneButton"));

        horizontalLayout_4->addWidget(removeFloorPlaneButton);
        ...
        sizePolicy2.setHeightForWidth(mesh_view->sizePolicy().hasHeightForWidth());
        mesh_view->setSizePolicy(sizePolicy2);
        ...
        marker_image = new ntk::ImageWidget(widget);
        marker_image->setObjectName(QString::fromUtf8("marker_image"));
        QSizePolicy sizePolicy4(QSizePolicy::Preferred, QSizePolicy::Preferred);
        sizePolicy4.setHorizontalStretch(0);
        sizePolicy4.setVerticalStretch(1);
        sizePolicy4.setHeightForWidth(marker_image->sizePolicy().hasHeightForWidth());
        marker_image->setSizePolicy(sizePolicy4);

        verticalLayout_3->addWidget(marker_image);
    ...
    void retranslateUi(QMainWindow *ModelAcquisitionWindow)
    {
        ...
        stopButton->setText(QApplication::translate("ModelAcquisitionWindow", "Stop", 0, QApplication::UnicodeUTF8));
        resetButton->setText(QApplication::translate("ModelAcquisitionWindow", "Reset", 0, QApplication::UnicodeUTF8));
        removeFloorPlaneButton->setText(QApplication::translate("ModelAcquisitionWindow", "Remove floor plane", 0, QApplication::UnicodeUTF8));
