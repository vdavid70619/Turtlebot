...
**
** Created: Mon Apr 30 12:46:57 2012
...
public:
    ...
    void setupUi(QMainWindow *RawImagesWindow)
    {
        ...
        RawImagesWindow->resize(800, 582);
        ...
        dockWidget->setMinimumSize(QSize(240, 146));
        ...
        dockWidget_2->setMinimumSize(QSize(240, 146));
    ...
    void retranslateUi(QMainWindow *RawImagesWindow)
    {
        ...
        dockWidget_2->setWindowTitle(QApplication::translate("RawImagesWindow", "Infrared Image (IR)", 0, QApplication::UnicodeUTF8));
